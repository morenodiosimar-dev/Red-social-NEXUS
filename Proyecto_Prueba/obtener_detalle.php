...
if (!$post)
    die("Error: No se encontró la publicación.");
...
<div class="flex flex-col md:flex-row h-full max-h-[80vh] bg-white relative">
    ...
    <div class="md:w-2/5 flex flex-col h-full bg-white">
        ...
        <div class="p-4 border-b flex justify-between items-center">
            <div>
                <span
                    class="font-bold text-sm"><?php echo htmlspecialchars($post['nombre'] . " " . $post['apellido']); ?></span>
            </div>
        </div>
        ...
        <div id="comentarios-lista-<?php echo $post_id; ?>" class="flex-grow overflow-y-auto p-4 space-y-3"
        ...
        <div class="p-4 border-t">
            <div class="flex justify-between items-center mb-2">
                <div class="flex gap-4">
                    <ion-icon name="<?php echo $is_liked ? 'heart' : 'heart-outline'; ?>"
                        id="modal-heart-<?php echo $post_id; ?>" onclick="reaccionarModal(<?php echo $post_id; ?>)"
                    ...
                    <ion-icon name="repeat-outline" onclick="mandarRepublicacion(<?php echo $post_id; ?>)"
                ...
                <?php if ($mostrar_boton): ?>
                    <button
                        onclick="<?php echo $es_republicacion_propia ? "window.eliminarRepublicacion({$post['repost_id']})" : "eliminarElemento({$post_id}, 'publicacion')"; ?>"
            ...
            <p class="text-sm font-bold mb-3" id="modal-count-<?php echo $post_id; ?>"><?php echo $total_likes; ?>
                reacciones</p>

            <div class="flex gap-2">
                <input type="text" id="modal-input-com-<?php echo $post_id; ?>" placeholder="Añadir un comentario..."
