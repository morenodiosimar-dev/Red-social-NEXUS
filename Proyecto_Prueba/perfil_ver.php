...
<body class="bg-white">
    ...
    <div class="perfil">
        <div class="perfil-usuario">
            <div class="superior">
                <div class="nombre-red"
                    style="font-size:35px;font-weight:bold;background:linear-gradient(45deg,#ff00cc,#3333ff);-webkit-background-clip:text;-webkit-text-fill-color:transparent;">
                    Nexus</div>
            </div>
            ...
            <div class="flex items-center gap-4">
                <div class="w-20 h-20 flex-shrink-0">
                    ...
                    <?php else: ?>
                        <ion-icon name="person-circle-outline" class="text-gray-300"
                ...
                <div class="texto-principal">
                    ...
                    <div class="flex gap-2 mt-2">
                        <button id="btn-seguir" data-seguido="<?php echo $id_perfil; ?>"
            ...
            <div class="perfiles flex justify-around border-b mt-4">
                <a href="?id=<?php echo $id_perfil; ?>&tab=personal"
                    class="perso p-2 <?php echo $tab == 'personal' ? 'active-tab' : ''; ?>">Personal</a>
                <a href="?id=<?php echo $id_perfil; ?>&tab=contenido"
                    class="cont p-2 <?php echo $tab == 'contenido' ? 'active-tab' : ''; ?>">Contenido</a>
            </div>

            <!-- CARRUSEL DE FOTOS -->
            <div class="mt-6">
                <h3 class="px-6 text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">Fotos
                    (<?= ucfirst($tab) ?>)</h3>
        ...
        <div class="iconos-inferiores fixed bottom-0 w-full bg-white border-t p-3 flex justify-around">
            <ion-icon name="home-outline" class="icon-gradient text-2xl"
                onclick="window.location.href='cuenta.php'"></ion-icon>
            <ion-icon name="search-outline" class="icon-gradient text-2xl"
                onclick="window.location.href='busqueda.php'"></ion-icon>
            <ion-icon name="chatbubble-outline" class="icon-gradient text-2xl"
                onclick="window.location.href='http://localhost:3000'"></ion-icon>
            <ion-icon name="person-outline" class="icon-gradient text-2xl"
